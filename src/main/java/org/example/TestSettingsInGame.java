...
public class TestSettingsInGame {
    ...
    @Test(priority = 3)
    void openSettings()throws InterruptedException, AWTException{
        ...
        Thread.sleep(2000);
        robot.mouseMove(targetX99, targetY99);
        Thread.sleep(2000);
        ...
        robot.mouseMove(targetX2, targetY2);
        Thread.sleep(1500);
        robot.mouseMove(targetX88, targetY88);
        Thread.sleep(2000);
    ...
    @Test(priority = 4)
    void changeSensitivity() throws InterruptedException, AWTException{
        Robot robot = new Robot();

        // Camera sensitivity Plus
        int targetX = 1592;
        int targetY = 699;
        // Move the mouse cursor to the target coordinates
        robot.mouseMove(targetX, targetY);
    ...
    @Test(priority = 5)
    void changeVolume() throws InterruptedException, AWTException{
        Robot robot = new Robot();
    ...
    @Test(priority = 6)
    void outPutDevice() throws InterruptedException, AWTException{
        Robot robot = new Robot();
    ...
    @Test(priority = 7)
    void closeSettings()throws InterruptedException, AWTException{
        Robot robot = new Robot();
    ...
    @Test(priority = 8)
    void leaveGame() throws InterruptedException, AWTException{
        Robot robot = new Robot();
